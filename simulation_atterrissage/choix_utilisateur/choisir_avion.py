from simulation_atterrissage.classes.avions.choix_avion import *
from simulation_atterrissage.choix_utilisateur.get_float_input import get_float_input  # Modifié ici
