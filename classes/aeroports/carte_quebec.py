"""Module pour la visualisation des aéroports du Québec sur une carte."""
...
def creer_carte_quebec():
    """Crée et affiche une carte interactive des aéroports du Québec.

    La carte est sauvegardée dans un fichier HTML et ouverte dans le navigateur par défaut.
    """
